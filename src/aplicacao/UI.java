...
public class UI {
	...
	public static PosicaoDoXadrez leiaPosicaoXadrez(Scanner leia) {
		try {
			...
			throw new InputMismatchException("Erro lendo posição do xadrez. Os valores válidos são de a1 até h8");
		}
	}

	public static void imprimirVez(PartidaDeXadrez partidaDeXadrez) {
